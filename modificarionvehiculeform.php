...
if (isset($_POST['modifier'])) {
    ...
    $sql = "UPDATE `vehicule` SET 
            ...
            `matricule`='$matricule', 
            `assurance`='$assurance', 
            `visittechnique`='$visittec', 
            `vidange`='$vidange', 
            `chainededistribution`='$chaindis', 
            `carburant`='$carburant', 
            `prix`='$prix', 
            `categorie`='$categorie', 
            `image`='$image', 
...
// Code pour pré-remplir le formulaire avec les données existantes
if (isset($_GET['id'])) {
    $id = $_GET['id'];
        ...
        <form action="#" method="post" >
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" value="<?= htmlspecialchars($vehicle['id'] ?? '') ?>" id="input1" name="input1" readonly>
                </div>
                <div class="form-group">
...
<div class="form-group">
    ...
    <input type="file" id="input13" name="input13" accept="image/*" required>
            ...
            <button type="submit" name="modifier" class="submit-btn">Modifier</button>
